          ...
          <div className={styles.mainContent}>
            <div className={styles.brand}>
              ...
              <div className={styles.socialLinks}>
                <a href="https://github.com/ashutoshgautams" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="GitHub">
                ...
                <a href="https://www.linkedin.com/in/ashutosh-gautam-3747b3179/" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="LinkedIn">
                  <svg className={styles.socialIcon} stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://twitter.com/ashutoshgautams" target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label="Twitter">
                  <svg className={styles.socialIcon} stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
