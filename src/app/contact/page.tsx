        ...
        <div className={styles.contactInfo}>
          ...
          <div className={styles.socialLinks}>
            ...
            <div className={styles.socialIcons}>
              <a href="https://github.com/ashutoshgautams" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/ashutosh-gautam-3747b3179/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="LinkedIn">
                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://twitter.com/ashutoshgautams" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Twitter">
                <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
